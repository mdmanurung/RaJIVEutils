...
![Heatmaps of raw data and RaJIVE joint, individual, and noise
decomposition for all blocks](reference/figures/README-heatmap-1.png)
...
|----|----|
| [`Rajive()`](https://mdmanurung.github.io/RaJIVEutils/reference/Rajive.md) | Run the RaJIVE decomposition on a list of data matrices. Returns an object of class `"rajive"`. |
| [`ajive.data.sim()`](https://mdmanurung.github.io/RaJIVEutils/reference/ajive.data.sim.md) | Simulate multi-block data with known joint and individual structure for testing and benchmarking. |

### Rank accessors

| Function | Description |
|----|----|
| [`get_joint_rank()`](https://mdmanurung.github.io/RaJIVEutils/reference/get_joint_rank.md) | Extract the estimated joint rank from a `"rajive"` object. |
| [`get_individual_rank()`](https://mdmanurung.github.io/RaJIVEutils/reference/get_individual_rank.md) | Extract the individual rank for a specific data block. |
| [`get_all_ranks()`](https://mdmanurung.github.io/RaJIVEutils/reference/get_all_ranks.md) | Return a `data.frame` of joint and individual ranks for all blocks at once. |

### Component accessors

| Function | Description |
|----|----|
| [`get_joint_scores()`](https://mdmanurung.github.io/RaJIVEutils/reference/get_joint_scores.md) | Return the shared n x r_J joint score matrix (r_J = joint rank). |
| [`get_block_scores()`](https://mdmanurung.github.io/RaJIVEutils/reference/get_block_scores.md) | Return the score matrix (U) for a given block and component type (joint or individual). |
| [`get_block_loadings()`](https://mdmanurung.github.io/RaJIVEutils/reference/get_block_loadings.md) | Return the loading matrix (V) for a given block and component type. |
| [`get_block_matrix()`](https://mdmanurung.github.io/RaJIVEutils/reference/get_block_matrix.md) | Return the full reconstructed matrix (J, I, or E) for a given block and component type. |

### S3 methods for `"rajive"` objects

| Function | Description |
|----|----|
| [`print.rajive()`](https://mdmanurung.github.io/RaJIVEutils/reference/print.rajive.md) | Print a concise summary of ranks for a `"rajive"` object. |
| [`summary.rajive()`](https://mdmanurung.github.io/RaJIVEutils/reference/summary.rajive.md) | Return and print a `data.frame` of all estimated ranks. |

### Variance explained

| Function | Description |
|----|----|
| [`showVarExplained_robust()`](https://mdmanurung.github.io/RaJIVEutils/reference/showVarExplained_robust.md) | Compute the proportion of variance explained by joint, individual, and residual components for each block (returns a list). |
| [`plot_variance_explained()`](https://mdmanurung.github.io/RaJIVEutils/reference/plot_variance_explained.md) | Stacked bar chart of variance explained by each component and block. |

### Visualisation

| Function | Description |
|----|----|
| [`decomposition_heatmaps_robustH()`](https://mdmanurung.github.io/RaJIVEutils/reference/decomposition_heatmaps_robustH.md) | Heatmaps of the raw data and the joint, individual, and noise components for all blocks. |
| [`plot_scores()`](https://mdmanurung.github.io/RaJIVEutils/reference/plot_scores.md) | Scatter plot of two score components for a given block (joint or individual), with optional group colouring. |

### Jackstraw significance testing

| Function | Description |
|----|----|
| [`jackstraw_rajive()`](https://mdmanurung.github.io/RaJIVEutils/reference/jackstraw_rajive.md) | Run the jackstraw permutation test to identify variables with significantly non-zero joint loadings. Returns a `"jackstraw_rajive"` object. |
| [`print.jackstraw_rajive()`](https://mdmanurung.github.io/RaJIVEutils/reference/print.jackstraw_rajive.md) | Print a significance table for a `"jackstraw_rajive"` object. |
| [`summary.jackstraw_rajive()`](https://mdmanurung.github.io/RaJIVEutils/reference/summary.jackstraw_rajive.md) | Return and print a `data.frame` summary of jackstraw results. |
| [`get_significant_vars()`](https://mdmanurung.github.io/RaJIVEutils/reference/get_significant_vars.md) | Extract significant variable names/indices for a given block and component from jackstraw results. |
| [`plot_jackstraw()`](https://mdmanurung.github.io/RaJIVEutils/reference/plot_jackstraw.md) | Diagnostic plots for jackstraw results: p-value histogram, F-stat scatter plot, or loadings significance heatmap. |
