...
wedin_bound_resampling_cpp_draws <- function(X, perp_basis, right_vectors, draws) {
    .Call(`_rajiveplus_wedin_bound_resampling_cpp_draws`, X, perp_basis, right_vectors, draws)
}
